           ...
           <div className="widgets__widgetContainer">
              ...
              <ul className='widgets__trendsContainer'>
                 <li>
                    ...
                    <div className='tweetNumber'>5012 Posts</div>
                 </li>
                 <li>
                    <div className='popular'>
                       <span>Popular in Kenya</span>         
                    ...
                    <div className='tweetNumber'>4099 Posts</div>
                 </li>
                 <li>
                    <div className='popular'>
                       <span>Popular in Kenya</span>         
                    ...
                    <div className='tweetNumber'>4022 Posts</div>
                 </li>
                 <li>
                    <div className='popular'>
                       <span>Popular in Kenya</span>         
                    ...
                    <div className='tweetNumber'>3088 Posts</div>
                 </li>
              </ul>
