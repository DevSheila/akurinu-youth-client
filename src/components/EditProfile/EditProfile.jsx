...
const EditProfile = ({profile, setUpdatedProfileState}) => {
    ...
    const {bio, userType, displayName, location, wallpaper, photoURL, website} = profile
        ...
        <>
            ...
            <div className='editProfile'>
                ...
                <form noValidate autoComplete="off">
                    ...
                    <TextField id="userType" label="userType" variant="filled" value={profileState.userType} onChange={e=>setProfileState({...profileState, userType:e.target.value})}/>
